...
case 
                ...
                else PURCHASE_ORDER.DESIRED_RECV_DATE end as Transaction_date,
...
WHERE (WORK_ORDER.TYPE='W') AND (WORK_ORDER.STATUS In ('F','R'))

)

select GETDATE() as 'Date Inserted', * 
from my_union where Transaction_date >= '01-01-2022'
