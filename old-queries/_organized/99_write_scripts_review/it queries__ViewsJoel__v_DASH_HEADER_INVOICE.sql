...
/****** Object:  View [ESI_EDI].[v_DASH_HEADER_INVOICE]    Script Date: 9/8/2021 1:28:26 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [ESI_EDI].[v_DASH_HEADER_INVOICE]
									AS
									...
									FROM [3CARMS\CAPROD].[VECA].[dbo].[RECEIVABLE] ERP_INH
										...
										LEFT JOIN (SELECT RCV_LIN.[INVOICE_ID]  AS [INVOICE_ID]
												   ...
												   FROM [3CARMS\CAPROD].[VECA].[dbo].[RECEIVABLE_LINE] RCV_LIN 
													   INNER JOIN [3CARMS\CAPROD].[VECA].[dbo].[SALES_TAX] TAX				
