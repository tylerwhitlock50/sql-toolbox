...
CUSTOMER_ORDER.ID, 
CUST_ADDRESS.NAME + '
 ' + CUST_ADDRESS.CITY+ ', ' + CUST_ADDRESS.STATE + ' ' + CUST_ADDRESS.ZIPCODE + ' 
'+ CUST_ADDRESS.COUNTRY as Address_comp

 

FROM VECA.dbo.CUST_ADDRESS CUST_ADDRESS inner join VECA.dbo.CUSTOMER_ORDER CUSTOMER_ORDER
