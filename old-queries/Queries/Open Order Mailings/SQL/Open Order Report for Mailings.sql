SELECT 
 ...
 CASE
	...
	else  CUSTOMER_ORDER.DESIRED_SHIP_DATE end as Request_Date,
...
*/
 ...
 case 
	when CUST_LINE_DEL.ORDER_QTY is not null then   CUST_LINE_DEL.ORDER_QTY 
	else CUST_ORDER_LINE.ORDER_QTY end as Qty_Ordered,
	
 case 
	when CUST_LINE_DEL.ORDER_QTY is not null then   CUST_LINE_DEL.SHIPPED_QTY
	else CUST_ORDER_LINE.TOTAL_SHIPPED_QTY end as Qty_Shipped,
 
 case 
	when CUST_LINE_DEL.ORDER_QTY is not null then   CUST_LINE_DEL.ORDER_QTY - CUST_LINE_DEL.SHIPPED_QTY
	else CUST_ORDER_LINE.ORDER_QTY - CUST_ORDER_LINE.TOTAL_SHIPPED_QTY end as Qty_Remaining
